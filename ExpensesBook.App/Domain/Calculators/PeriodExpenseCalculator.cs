...
public sealed class PeriodExpenseCalculator
{
...
public sealed record TableRow(string Value1, string Value2, string Value3, Guid? RelatedId);

public sealed class PeriodExpensesTableData
{
